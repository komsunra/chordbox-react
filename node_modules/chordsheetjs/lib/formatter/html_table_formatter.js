...
var template = _runtime2.default.template({
  "1": function _(container, depth0, helpers, partials, data, blockParams) {
    ...
    return ((stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.title : depth0, {
      ...
      "data": data,
      "blockParams": blockParams
    })) != null ? stack1 : "") + ((stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.bodyLines : depth0, {
      "name": "if",
      "hash": {},
  ...
  "6": function _(container, depth0, helpers, partials, data, blockParams) {
    var stack1;
    return "<div class=\"chord-sheet\">" + ((stack1 = helpers.each.call(depth0 != null ? depth0 : container.nullContext || {}, depth0 != null ? depth0.paragraphs : depth0, {
      "name": "each",
      "hash": {},
  ...
  "7": function _(container, depth0, helpers, partials, data, blockParams) {
    var stack1,
        alias1 = depth0 != null ? depth0 : container.nullContext || {};
    return "<div class=\"" + container.escapeExpression((helpers.paragraphClasses || depth0 && depth0.paragraphClasses || helpers.helperMissing).call(alias1, blockParams[0][0], {
      "name": "paragraphClasses",
      "hash": {},
      "data": data,
      "blockParams": blockParams
    })) + "\">" + ((stack1 = helpers.each.call(alias1, depth0 != null ? depth0.lines : depth0, {
      "name": "each",
      "hash": {},
  ...
  "9": function _(container, depth0, helpers, partials, data, blockParams) {
    ...
    return "<table class=\"" + container.escapeExpression((helpers.lineClasses || depth0 && depth0.lineClasses || alias2).call(alias1, blockParams[1][0], {
      "name": "lineClasses",
      "hash": {},
      "data": data,
      "blockParams": blockParams
    })) + "\">" + ((stack1 = helpers["if"].call(alias1, (helpers.hasChordContents || depth0 && depth0.hasChordContents || alias2).call(alias1, blockParams[1][0], {
      ...
      "data": data,
      "blockParams": blockParams
    })) != null ? stack1 : "") + ((stack1 = helpers["if"].call(alias1, (helpers.hasTextContents || depth0 && depth0.hasTextContents || alias2).call(alias1, blockParams[1][0], {
  ...
  "10": function _(container, depth0, helpers, partials, data, blockParams) {
    var stack1;
    return "<tr>" + ((stack1 = helpers.each.call(depth0 != null ? depth0 : container.nullContext || {}, depth0 != null ? depth0.items : depth0, {
      "name": "each",
      "hash": {},
  ...
  "11": function _(container, depth0, helpers, partials, data, blockParams) {
    var stack1,
        alias1 = depth0 != null ? depth0 : container.nullContext || {};
    return (stack1 = helpers["if"].call(alias1, (helpers.isChordLyricsPair || depth0 && depth0.isChordLyricsPair || helpers.helperMissing).call(alias1, blockParams[0][0], {
  ...
  "12": function _(container, depth0, helpers, partials, data) {
    var helper;
    return "<td class=\"chord\">" + container.escapeExpression((helper = (helper = helpers.chords || (depth0 != null ? depth0.chords : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
      "name": "chords",
      "hash": {},
      "data": data
    }) : helper)) + "</td>";
  },
  "14": function _(container, depth0, helpers, partials, data, blockParams) {
    var stack1;
    return "<tr>" + ((stack1 = helpers.each.call(depth0 != null ? depth0 : container.nullContext || {}, depth0 != null ? depth0.items : depth0, {
      "name": "each",
      "hash": {},
  ...
  "16": function _(container, depth0, helpers, partials, data) {
    var helper;
    return "<td class=\"lyrics\">" + container.escapeExpression((helper = (helper = helpers.lyrics || (depth0 != null ? depth0.lyrics : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
      "name": "lyrics",
      "hash": {},
      "data": data
    }) : helper)) + "</td>";
  ...
  "19": function _(container, depth0, helpers, partials, data) {
    var helper;
    return "<td class=\"comment\">" + container.escapeExpression((helper = (helper = helpers.value || (depth0 != null ? depth0.value : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
      "name": "value",
      "hash": {},
      "data": data
    }) : helper)) + "</td>";
...
var HtmlTableFormatter = function () {
